 ...
 * 							여러 스레드가 동시에 read작업은 가능하지만, 
 * 							write작업은 단지 하나의 스레드만 가능함.
 * 							=> write보다 read위주의 작업이 많이 발생하는 경우에 사용하면 유리하다.
 */
...
class BankThread2 extends Thread{
	private LockAccount sAcc;

	public BankThread2(LockAccount sAcc) {
		this.sAcc = sAcc;
	}

	@Override
	public void run() {
		boolean result = sAcc.withdraw(6000); // 6000

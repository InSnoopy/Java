 ...
 */
	...
	// 서울() <- 이런식으로 ()가 생략되어서 보인다.
	//public enum City {서울(), 부산(), 대구(), 광주(), 대전()};
	//City(){
	// } -> 위에 생성자도 있는데 생략되어 있는 것이다.
	 ...
	 */
		...
		// 타입 자체가 다르기 때문에 아래 코드는 error난다.
		// City, Hometown은 타입이 서로 다르다.
		// System.out.println(city == Hometown.대구;
		
		// enum에도 compareTo()메소드가 있다.
		// ordinal() 값의 순서로 비교한다.

...
/*
 * 싱클턴 패턴 => 객체(인스턴스)를 한 개만 만들어지도록 하는 프로그래밍 방법
 * 
 ...
 *	(이 메서드의 이름은 보통 getInstance로 지정한다.)
 */
	
	// 자기 자신의 class 참조값을 저장하는 멤버변수 선언
	// 메서드가 static이기 떄문에 single 멤버도 static이여야 한다.
	...
	// static이 아닌 경우 new로 객체를 생성해서 사용가능하기 때문이다.

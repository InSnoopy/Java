 ...
 */
	...
	public void destroy() {
		...
		System.out.println("T08ServletFilter2.destory()"
				+ " 호출됨");
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		System.out.println("T08ServletFilter2.doFilter()"
				+ " 시작...");
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		...
		System.out.println("T08ServletFilter2.init()"
				+ " 호출됨");

...
class Member implements Serializable{
	...
	// Serializable 인터페이스는 껍데기만 있다. 추상 메서드가 없다.
	// 타입만 Serializable이라는 것을 알려주는 역할을 한다. (이런 인터페이스를 태그 인터페이스라고 한다.) - 표시용 인터페이스
	
	/*
	 * transient => 직렬화가 되지 않을 멤버변수에 지정한다.
	 * 				(*static 변수도 직렬화 대상에서 제외된다.) 
	 * 

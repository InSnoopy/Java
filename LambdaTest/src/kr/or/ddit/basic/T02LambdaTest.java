...
/*
  ...
  6) 실행문이 return문만 있을 경우 return명령과 '{}'를 생략할 수 있다.
  예) (a, b) -> a + b
 */
		
/*
 * LambdaInterface1 // 반환값이 없고 매개변수도 없는 추상메서드
 * LambdaInterface2 // 반환값이 없고 매개변수는 있는 추상메서드
 * LambdaInterface3 // 반환값도 있고 매개변수도 있는 추상메서드
 */
